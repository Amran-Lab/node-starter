...
// the last login timestamp as 0 (0 = Unix Epoch i.e., Jan 00 0970) to indicate that no previous login attempts have been recorded.

const insertUsers = `
INSERT INTO Users(userid,friendlyname,emailaddress,password,admin,lastlogin) VALUES
